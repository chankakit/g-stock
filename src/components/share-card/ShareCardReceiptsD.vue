...
const dynamicLogoUrl = ref('/imgs/share-card/the-receipts-chaoding/logo-l-red@2x.png')
if(props.stock.change_pct < 0) {
  dynamicLogoUrl.value = '/imgs/share-card/the-receipts-chaoding/logo-l-green@2x.png'
}
...
<template>
  <div class="receipts-style">
    <div class="the-title" style="position: absolute;">
      <img src="/imgs/share-card/the-receipts-chaoding/the-receipts-title-chaoding-l.svg" />
    </div>
